...
pub enum Fix {
    RemoveExcludeAndUseInclude(Patterns),
    RemoveExclude,
}
...
fn find_include_patterns_that_incorporate_exclude_patterns(
    _entries_to_exclude: &[TarHeader],
    include_patterns: Patterns,
    _exclude_patterns: Patterns,
) -> Vec<String> {
    include_patterns
}
