...
fn find_include_patterns_that_incorporate_exclude_patterns(
    ...
    (new_include_patterns, removed_include_patterns)
}
        ...
        assert_eq!(
            ...
            Report::Version {
                ...
                suggested_fix: Some(Fix::RemoveExcludeAndUseInclude {
                    ...
                    removed_include: vec!["pregenerated/*".into()]
        })
            },
